...
public class TabelaKlientowFakturka extends JTable {
	private static String[] nazwyKolumn = { "L.P.", "Nazwa Firmy", "Imie", 
			"Nazwisko", "NIP", "Adres"};
	...
	public TabelaKlientowFakturka() {
		super();
		this.setParameters();
	}

	public TabelaKlientowFakturka(Object[][] data, String[] nazwy) {
		super(data, nazwy);
		this.setParameters();
	}

	public TabelaKlientowFakturka(Object[][] data) {
		super(data, nazwyKolumn);
		this.setParameters();
	}
	
	public TabelaKlientowFakturka(DefaultTableModel deufaltTableModel) {
